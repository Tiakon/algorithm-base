...
public class LC706 {
    ...
    public void case01Test() {
        ...
        myHashMap.put(2, 2);
        Assert.assertEquals(2, myHashMap.get(2));
    ...
    public void case02Test() {
        ...
        myHashMap.put(32, 1);
        myHashMap.put(48, 1);
        Assert.assertEquals(1, myHashMap.get(45));
        Assert.assertEquals(12, myHashMap.size);

        myHashMap.remove(28);
        myHashMap.remove(14);
        myHashMap.remove(16);
        Assert.assertEquals(9, myHashMap.size);
        Assert.assertEquals(-1, myHashMap.get(28));
        Assert.assertEquals(-1, myHashMap.get(14));
        Assert.assertEquals(-1, myHashMap.get(16));
        myHashMap.put(60, 1);
        Assert.assertEquals(1, myHashMap.get(42));
        Assert.assertEquals(1, myHashMap.get(15));
        Assert.assertEquals(1, myHashMap.get(48));
    ...
    public void case03Test() {
        ...
        myHashMap.remove(19);
        myHashMap.remove(0);
        Assert.assertEquals(-1, myHashMap.get(18));
        myHashMap.put(42, 0);
        Assert.assertEquals(-1, myHashMap.get(19));
        myHashMap.remove(42);
        Assert.assertEquals(1, myHashMap.size);
        myHashMap.put(17, 90);
        myHashMap.put(31, 76);
        ...
        myHashMap.put(5, 50);
        myHashMap.put(7, 68);
        Assert.assertEquals(6, myHashMap.size);
        myHashMap.put(73, 74);
        myHashMap.put(85, 18);
        myHashMap.put(74, 95);
        Assert.assertEquals(9, myHashMap.size);
        ...
        myHashMap.put(51, 40);
        myHashMap.put(33, 76);
        Assert.assertEquals(14, myHashMap.size);
        Assert.assertEquals(90, myHashMap.get(17));
        Assert.assertEquals(-1, myHashMap.get(42));
    }
}
 ...
 * 数组+链表+自动扩容机制
 *
 * @author tiankai.me@gmail.com on 2023-08-09 15:12.
 */
class MyHashMap {
